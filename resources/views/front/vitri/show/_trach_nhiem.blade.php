            ...
            @foreach ($viTri->nhiemVu as $nhiemVu)
                ...
                @foreach ($nhiemVu->moTaNhiemVu as $moTa)
                    <tr>
                        ...
                        <td>
                            <div class="editable" data-action="updateMoTaKetQua" ondblclick="editTask(this, '{{ $moTa->id }}')">
                                {{ $moTa->ket_qua }}
...
function addMoTaInput(element, idNhiemVu) {
    ...
    tr.innerHTML = `
        ...
        <td>
            <input type="text" class="edit-textarea" placeholder="Nhập kết quả..." id="input-ket-qua-${idNhiemVu}">
        </td>
    `;
