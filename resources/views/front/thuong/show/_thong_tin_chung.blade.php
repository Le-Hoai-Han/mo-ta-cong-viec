        ...
        <div class="card-header pb-0 p-3 bg-dark">
            <div class="row">
                ...
                <div class="col-6 text-end">
                    <a href="{{route('thuong-nhan-vien.index')}}" class="btn btn-secondary btn-md mb-2"><i class="fas fa-undo" aria-hidden="true"></i> Quay về</a> 
                ...
                <div class="input-group mb-3">
                    ...
                    <select name="thang_su_dung" id="thang_su_dung" aria-label="Tháng" placeholder="Thời gian áp dụng" class="form-control ">
                        ...
                        @foreach ($dsThangNam as $thang)
                            <option value="{{$thang->id}}" data-url="{{route('thuong-nhan-vien.show',['thuong_nhan_vien'=>$thang])}}" 
                ...
                <div class="col-12 col-md-6">
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <button onclick="tinhNganSachThuong('{{route('thuong-nhan-vien.tinhNganSachThuong',['thuongNhanVien'=>$thuongNhanVien])}}')" class="btn btn-warning btn-md mb-0" type="button" id="button-ngan-sach">
                            <div class="d-flex align-items-center">         
...
<script defer>
    document.querySelector('#btn_thuong_thang_chon').addEventListener('click',()=>{
        let urlThuong = "{{url('thuong-nhan-vien')}}/"+document.querySelector('#thang_su_dung').value;
