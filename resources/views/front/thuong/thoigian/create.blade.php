<?php 
$current = "Thêm thông tin thưởng theo quý";
$list = [    
    ...
    <div class="main-div">
        <div class="row " >
                <div class="col-12">
                    ...
                    <form name="them_thuong_nam" method="POST" id="frm_them_thuong_thoi_gian" action="{{route('thuong-thoi-gian.store')}}">
                            ...
                            <div class="card-header pb-0 p-3">
                                <div class="row">
                                    <div class="col-6 d-flex align-items-center">
                                        <h6 class="mb-0">Thêm thông tin thưởng theo quý</h6>
                                    </div>
                    ...
                    if(dsChiTieuTheoNhom) {
                        for(idChiTieu in dsChiTieuTheoNhom) {
                            ...
                            if(chiTieu.muc_tieu_mac_dinh!==null) {
                                mucTieu = chiTieu.muc_tieu_mac_dinh*3;
                            }
