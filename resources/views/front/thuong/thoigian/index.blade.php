<?php 
$current = "Danh sách tiền thưởng nhân viên theo quý";
...
<x-dashboard-layout :current="$current">
        ...
        <div class="row " >
                ...
                <div class="card">
                        <div class="card-header pb-0 p-3">
                            <div class="row">
                                <div class="col-6 d-flex align-items-center">
                                  <h6 class="mb-0">Danh sách tiền thưởng nhân viên theo quý</h6>
                                </div>
                        ...
                        <div class="card-body over-flow-y">
                            ...
                            <div class="">
                                <table class="table" id="thuong-thoi-gian-table">
                                    <thead>
                                        <tr >
                                            <th>ID
                                            ...
                                            <th>Tên nhân viên      
                                                <input type="text" id="sch_nv_ho_ten" placeholder="" value="{{$thuongKhoangThoiGian->ho_ten}}" class="form-control" >  
                                            </th>  
                                            <th>Quý
                                                <input type="text" id="sch_nv_quy_ap_dung" placeholder="" value="{{$thuongKhoangThoiGian->quy}}" class="form-control" >
                                            </th>                                                                        
                                            <th>Năm
                                                <input type="text" id="sch_nv_nam_ap_dung" placeholder="" value="{{$thuongKhoangThoiGian->nam}}" class="form-control" >
                                            </th>                                            
                                            <th>Ngân sách thưởng
                                                <input type="text" id="" placeholder="" class="form-control" readonly disabled>
                                            </th>
    ...
    <script type="text/javascript" async>
        ...
        let table;
        $(function() {
            table = $('#thuong-thoi-gian-table').DataTable({
                processing: true,
                serverSide: true,
                displayLength: 12,
                ajax: {
                    url:'{!! route('thuong-thoi-gian.getData') !!}',
                    method:'post',
                    data: function(d){
                        d.quy = $("#sch_nv_quy_ap_dung").val();
