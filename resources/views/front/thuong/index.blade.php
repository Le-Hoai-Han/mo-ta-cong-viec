<?php 
$current = "Danh sách tiền thưởng nhân viên";
                        ...
                        <div class="card-header pb-0 p-3">
                            <div class="row">
                                <div class="col-6 d-flex align-items-center">
                                  <h6 class="mb-0">Danh sách tiền thưởng nhân viên</h6>
                                </div>
                                <div class="col-6 text-end">
                                    ...
                                    @if(auth()->user()->can('add_thuongnhanvien'))
    ...
    <script type="text/javascript" async>
        ...
        $(function() {
            table = $('#thuong-nhan-vien-table').DataTable({
                ...
                displayLength: 12,
                ajax: {
                    url:'{!! route('thuong-nhan-vien.getData') !!}',
                    method:'post',
                    data: function(d){
