<?php $current = "Đơn hàng đã duyệt"; ?>

<x-dashboard-layout :current="$current">
<x-slot name="title">Đơn hàng đã duyệt</x-slot>
                    ...
                    <div class="card-header pb-0 p-3">
                        <div class="row">
                            <div class="col-6 d-flex align-items-center">
                                <h6 class="mb-0">Đơn hàng đã duyệt</h6>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        $(function() {
            table = $('#don-hang-da-duyet-table').DataTable({
                ...
                serverSide: true,
                ajax:{
                   url: '{!! route('don-hang-da-duyet.anyData') !!}',
                   method:'post',
                   data:function(d){
                ...
                columns: [
                    ...
                    { data: 'ngay_thuc_hien', name: 'ngay_thuc_hien', searchable: false,className:'px-24' },
