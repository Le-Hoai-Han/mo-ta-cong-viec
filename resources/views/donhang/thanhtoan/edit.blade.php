...
<x-dashboard-layout :list="$list" :current="$current">
    <div class="col-12 col-md-6">
        <x-simple-card extClass="mt-3 " headerClass="bg-info text-white">
            <x-slot name="title">
                <h6 class="text-white">Cập nhật thanh toán</h6>
            </x-slot>
            <x-slot name="button">
            ...
            <form 
                action="
                {{route('don-hang.thanh-toan.update',[
                    'don_hang'=>$donHang,
            ...
            >
                ...
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" value="{{old('so_tien_thanh_toan',thuGonSoLe($thanhToan->so_tien_thanh_toan))}}" name="so_tien_thanh_toan" id="so_tien_thanh_toan"  onfocus="focused(this)" onfocusout="defocused(this)">
                ...
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" value="{{old('ngay_thanh_toan',formatNgayDMY($thanhToan->ngay_thanh_toan))}}" name="ngay_thanh_toan" id="ngay_thanh_toan"  onfocus="focused(this)" onfocusout="defocused(this)">
